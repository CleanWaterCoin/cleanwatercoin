...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in cleanwatercoin
    bool fStrictPayToScriptHash = true; // Always active in cleanwatercoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "cleanwatercoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "March 28, 2013 Oculus didn't expect such a negative reaction to Facebook deal";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x2416eaf5c49628c2cce0d4e8e4213af549ec5a64d6368e5f263f914e128bf51d"));
